 ...
 */
 package com.example.deepankur.diagnosisapplication.explosion;
...
public class ExplosionAnimator extends ValueAnimator {
    ...
    private static final float X = com.example.deepankur.diagnosisapplication.explosion.Utils.dp2Px(5);
    private static final float Y = com.example.deepankur.diagnosisapplication.explosion.Utils.dp2Px(20);
    private static final float V = com.example.deepankur.diagnosisapplication.explosion.Utils.dp2Px(2);
    private static final float W = com.example.deepankur.diagnosisapplication.explosion.Utils.dp2Px(1);
